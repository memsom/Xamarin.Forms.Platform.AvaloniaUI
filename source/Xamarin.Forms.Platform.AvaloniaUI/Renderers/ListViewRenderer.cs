...
public class ListViewRenderer : ViewRenderer<ListView, FormsListView>
{
    ...
    //void SendScrolled(object sender, AScrollChangedEventArgs e)
    //{
    ...
    void UpdateItemSource()
    {
        ...
        if (Element.IsGroupingEnabled)
        {
            ...
            Control.Items.ReplaceRange(items);
        }
        else
        {
    ...
    {
        if (defaultVerticalScrollVisibility == null)
        {
        ...
        switch (Element.VerticalScrollBarVisibility)
        {
            ...
            case (ScrollBarVisibility.Default):
                ScrollViewer.SetVerticalScrollBarVisibility(Control, (global::Avalonia.Controls.Primitives.ScrollBarVisibility)defaultVerticalScrollVisibility);
                break;
        }
    }
    ...
    {
        if (defaultHorizontalScrollVisibility == null)
        {
        ...
        switch (Element.HorizontalScrollBarVisibility)
        {
            ...
            case (ScrollBarVisibility.Never):
                ...
                break;
            case (ScrollBarVisibility.Default):
                ScrollViewer.SetHorizontalScrollBarVisibility(Control, (global::Avalonia.Controls.Primitives.ScrollBarVisibility)defaultHorizontalScrollVisibility);
                break;
        }
    }
    ...
    void OnCollectionChanged(object? sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e) => UpdateItemSource();

    void OnGroupedCollectionChanged(object? sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e) => UpdateItemSource();
