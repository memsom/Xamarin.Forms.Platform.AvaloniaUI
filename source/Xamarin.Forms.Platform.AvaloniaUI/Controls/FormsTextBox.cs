...
public class FormsTextBox : TextBox
{
    ...
    public static readonly StyledProperty<AvaloniaBrush> PlaceholderForegroundBrushProperty = AvaloniaProperty.Register<FormsTextBox, AvaloniaBrush>(nameof(PlaceholderForegroundBrush));
    ...
    public AvaloniaBrush PlaceholderForegroundBrush
    {
    ...
    {
        get => GetValue(DisabledTextProperty);
    ...
    protected override void OnKeyDown(KeyEventArgs e)
    {
        if (IsPassword)
        {
            ...
            if (e.Key is Key.C or Key.X or Key.Z or Key.Y && ctrlDown)
            {
                e.Handled = false;
                return;
            }
