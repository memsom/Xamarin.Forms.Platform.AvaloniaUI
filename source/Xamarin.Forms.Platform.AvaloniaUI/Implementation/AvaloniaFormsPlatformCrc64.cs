...
/// </summary>
internal class AvaloniaFormsPlatformCrc64 : HashAlgorithm
{
    static AvaloniaFormsPlatformCrc64 _instance;

    public static AvaloniaFormsPlatformCrc64 Instance
    {
        get
        {
            if (_instance == null) _instance = new AvaloniaFormsPlatformCrc64();

            return _instance;
        }
    }

    AvaloniaFormsPlatformCrc64() { }
