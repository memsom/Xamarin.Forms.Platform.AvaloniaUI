...
{
    public static IAvaloniaReadOnlyList<Visual> GetVisualChildren(Visual parent) => new AvaloniaList<Visual>(parent.GetVisualChildren());
    ...
    public static T? TryFindFromPoint<T>(InputElement reference, Avalonia.Point point) where T : Visual
    {
        ...
        return TryFindParent<T>((Visual)element);
    }
